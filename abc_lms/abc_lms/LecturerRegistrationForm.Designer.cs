namespace abc_lms
{
    partial class LecturerRegistrationForm
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LecturerRegistrationForm));
			...
			// lblLecturerId
			// 
			resources.ApplyResources(this.lblLecturerId, "lblLecturerId");
			...
			// lblLecturerName
			// 
			resources.ApplyResources(this.lblLecturerName, "lblLecturerName");
			...
			// txtLecturerName
			// 
			resources.ApplyResources(this.txtLecturerName, "txtLecturerName");
			this.txtLecturerName.Name = "txtLecturerName";
			// 
			// txtLecturerId
			// 
			resources.ApplyResources(this.txtLecturerId, "txtLecturerId");
			...
			resources.ApplyResources(this.addBooks_clearBtn, "addBooks_clearBtn");
			...
			resources.ApplyResources(this.lecpanel2, "lecpanel2");
			this.lecpanel2.Name = "lecpanel2";
			this.lecpanel2.Paint += new System.Windows.Forms.PaintEventHandler(this.lecpanel2_Paint);
			// 
